...
public:
	...
	bool addConnectionTo(int,int iFailed=0);			// adds a connection to a certain waypoint
...
public:
	...
	int getFailed(void)const{
		if(m_pPath)
			return m_pPath->m_piFailed[m_iIndex];
		else
			return 0;
	}
